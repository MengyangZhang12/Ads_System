...
public class CommonResponseDataAdvice implements ResponseBodyAdvice<Object> {
    ...
    // IgnoreResponseAdvice注解是自己定义的，见annotation.IgnoreResponseAdvice
    @Override
    @SuppressWarnings("all")
    public boolean supports(MethodParameter methodParameter,
                            Class<? extends HttpMessageConverter<?>> aClass) { //响应是否支持拦截
    ...
    @SuppressWarnings("all")
    //写入响应之前需要的操作
    public Object beforeBodyWrite(@Nullable Object o, //o代表返回对象
